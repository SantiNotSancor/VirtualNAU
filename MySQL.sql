...
INSERT INTO demsar (art, quantity, date) VALUES
    ...
    ('Pantalón', 30, '2022-10-13'),
    ('Pantalón', 152, '2022-10-15'),
    ('Pantalón', 2, '2022-10-16'),
    ('Pantalón', 15, '2022-9-20'),
    ('Pantalón', 26, '2022-11-20'),
    ('Pantalón', 16, '2022-11-06'),
    ('Pantalón', 40, '2022-12-20'),
    ('Pantalón', 39, '2021-12-01'),
    ...
    ('Riñonera', 8, '2022-10-02'),
    ('Riñonera', 20, '2022-12-26'),
    ('Riñonera', 30, '2022-10-16'),
    ('Riñonera', 20, '2022-10-29'),
    ('Riñonera', 1, '2022-11-10'),

    ('Cartuchera', 159, '2012-05-25'),
    ('Cartuchera', 81, '2022-11-22'),
    ('Cartuchera', 63, '2022-11-24'),
    ('Cartuchera', 105, '2022-11-24'),
    ('Cartuchera', 101, '2022-11-24'),
    ('Cartuchera', 11, '2022-10-24'),
    ('Cartuchera', 33, '2022-10-24'),
    ('Cartuchera', 43, '2022-12-24');